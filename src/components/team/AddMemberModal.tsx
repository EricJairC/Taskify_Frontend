                        ...
                        <div className="flex min-h-full items-center justify-center p-4 text-center">
                            ...
                            >
                                <Dialog.Panel className="w-full max-w-4xl transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all p-8">
                                    ...
                                    <p className="text-lg font-normal text-gray-600">Busca el nuevo integrante por email {''}
                                        <span className="text-colorPrimario font-semibold">para agregarlo al proyecto</span>
                                    </p>
                                    <AddMemberForm/>
                                </Dialog.Panel>
                            </Transition.Child>
